...
public class ArticleListActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCoordinatorLayout = findViewById(R.id.coordinator_layout_main_activity);
        ...
        mNestedScrollView = findViewById(R.id.swipe_refresh_layout);

        mRecyclerView = findViewById(R.id.rcv_articles_list);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            super(view);
            thumbnailView = view.findViewById(R.id.item_thumbnail);
            titleView = view.findViewById(R.id.item_article_title);
            subtitleView = view.findViewById(R.id.item_article_subtitle);
        }
    }
